...
export const GET: RequestHandler = async (event) => {
	...
	try {
		...
		console.error('Database error in GET /api/projects/[id]/work-items:', err);
		throw error(500, 'Failed to fetch work items. Database connection error.');
	}
};
...
export const POST: RequestHandler = async (event) => {
	...
	try {
		...
		console.error('Database error in POST /api/projects/[id]/work-items:', err);
		throw error(500, 'Failed to create work item. Database connection error.');
	}
};
